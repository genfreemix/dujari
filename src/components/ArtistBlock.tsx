    ...
    <section id="artist" className="scroll-mt-16 md:scroll-mt-20 bg-black pt-0 pb-20 md:pb-28 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-start">
        ...
        <div className="md:pt-14 lg:pt-16">
          ...
          <Link
            href="/artist"
            className="inline-flex min-w-[18rem] justify-center border border-white/15 text-white/55 text-xs tracking-[0.35em] uppercase px-10 py-4 mt-2 hover:border-white/28 hover:text-white/75 transition-all duration-300"
          >
            {t("artist_block.cta")}
          </Link>
        </div>
