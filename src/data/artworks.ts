...
export interface Artwork {
  ...
  detailSpecs?: {
    materials?: { en: string; ru: string; fr: string };
    technique?: { en: string; ru: string; fr: string };
    base?: { en: string; ru: string; fr: string };
    status?: { en: string; ru: string; fr: string };
  };
  price: string;
  dimensions: string;
  year: number;
...
export const artworks: Artwork[] = [
  ...
  },
  {
    ...
    detailSpecs: {
      ...
      base: {
        en: "reworked absinthe bottle, 0.7 l",
        ru: "переработанная бутылка абсента, 0.7 л",
        fr: "bouteille d'absinthe retravaillée, 0.7 l",
      },
      status: {
        en: "collectible object",
        ru: "коллекционный объект",
    ...
    dimensions: "30 × 10 cm",
    year: 2025,
    image: "/artworks/absinthe-tiger.jpg",
    color: "#2E7BEA",
    available: true,
    edition: "1/1",
  },
