...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "contact.step1_text": "Write directly via WhatsApp or Telegram. We'll confirm availability, agree on the details, and arrange delivery. No forms — just a conversation.",
  ...
  ru: {
    ...
    "contact.step1_text": "Напишите напрямую в WhatsApp или Telegram. Мы подтвердим наличие, согласуем детали и организуем доставку. Никаких форм — только диалог.",
  ...
  fr: {
    ...
    "contact.step1_text": "Écrivez directement via WhatsApp ou Telegram. Nous confirmerons la disponibilité, discuterons des détails et organiserons la livraison. Pas de formulaires — juste une conversation.",
